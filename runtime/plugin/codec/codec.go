// Package codec gives a script the conversions between bytes, hex, bits and
// integers, and a checksum. Importing it is what enables it.
//
// The base encodings are not here. base64 left on 2026-09-23 and base32 on
// 2026-09-24, each to a module of its own: encode and decode are words a
// script uses for several things and read better behind the encoding they
// belong to, and what is left here converts between representations of the
// same bytes rather than encoding them as text.
//
...
// Values returns the thirteen names this plugin supplies.
//
// Revisions:
//   - 2026-09-21 10:35: initial creation
//   - 2026-09-21 15:25: the base encodings and the checksum
//   - 2026-09-23 23:20: base64 moved to a module of its own
//   - 2026-09-24 00:53: base32 did too
